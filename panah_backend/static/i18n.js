...
const I18N = {
  ur: {
    ...
    review: {
      title: "اپنا جائزہ شیئر کریں",
      lead: "ہم آپ کی رائے سننا چاہیں گے۔",
      formReview: "آپ کا جائزہ",
      formSubmit: "جائزہ بھیجیں",
      note: "آپ کی رائے کا شکریہ!",
      thankYou: "آپ کے جائزے کا شکریہ!",
      allReviews: "لوگ کیا کہہ رہے ہیں",
      noReviews: "ابھی کوئی جائزہ نہیں — پہلا جائزہ دیں!",
    },
    privacy: {
    ...
    auth: {
      ...
      phoneInvalid: "موبائل نمبر ادھورا لگتا ہے — 10 ہندسے لکھیں (مثلاً 3001234567)۔",
      sendFailed: "کوڈ بھیجنے میں مسئلہ ہوا۔ نمبر چیک کر کے دوبارہ کوشش کریں۔",
      codeSentTo: "کوڈ بھیجا گیا {number} پر",
      sending: "بھیجا جا رہا ہے…",
      verifying: "تصدیق ہو رہی ہے…",
      otpInvalid: "6 ہندسوں کا کوڈ لکھیں۔",
      sessionExpired: "سیشن ختم ہو گیا۔ نمبر دوبارہ جمع کرائیں۔",
      otpWrong: "کوڈ صحیح نہیں یا ختم ہو گیا۔ دوبارہ کوشش کریں۔",
    },
  },
  ...
  en: {
    ...
    auth: {
      ...
      phoneInvalid: "Mobile number looks incomplete — enter 10 digits (e.g. 3001234567).",
      sendFailed: "Couldn't send the code. Check the number and try again.",
      codeSentTo: "Code sent to {number}",
      sending: "Sending…",
      verifying: "Verifying…",
      otpInvalid: "Enter the 6-digit code.",
      sessionExpired: "Session expired. Please submit your number again.",
      otpWrong: "Code is incorrect or has expired. Please try again.",
    },
  },
  ...
  roman: {
    ...
    review: {
      title: "Apna jaiza share karein",
      lead: "Hum aap ki rae sunna chahein ge.",
      formReview: "Aap ka jaiza",
      formSubmit: "Jaiza bhejein",
      note: "Aap ki rae ka shukriya!",
      thankYou: "Aap ke jaize ka shukriya!",
      allReviews: "Log kya keh rahe hain",
      noReviews: "Abhi koi jaiza nahi — pehla jaiza dein!",
    },
    privacy: {
    ...
    auth: {
      ...
      phoneInvalid: "Mobile number adhoora lagta hai — 10 digit number likhein (e.g. 3001234567).",
      sendFailed: "Code bhejne mein masla hua. Number check karke dobara koshish karein.",
      codeSentTo: "Code bheja gaya {number} par",
      sending: "Bheja ja raha hai…",
      verifying: "Verify ho raha hai…",
      otpInvalid: "6-digit code likhein.",
      sessionExpired: "Session expire ho gaya. Number dobara submit karein.",
      otpWrong: "Code sahi nahi hai ya expire ho gaya. Dobara koshish karein.",
    },
  },
};
